...
import { FaHeart, FaInfoCircle, FaMinus, FaPlus, FaShareAlt, FaStar, FaStore } from "react-icons/fa";
      ...
      <div className="container mx-auto px-4">
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 mb-12">
          ...
          <div className="flex flex-col space-y-6">
            <h1 className="text-4xl font-bold text-secondary">{product.productName}</h1>
            ...
            <div className="space-y-2 text-text-secondary">
              ...
              <p className="text-sm">
                * Refund policy: {product.productTangible ? "1-day money-back guarantee! I'm being generous!" : "Final sale, no refunds."}
              </p>
            </div>
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="md:col-span-1 bg-support-gray-dark rounded-lg p-6">
            <h2 className="text-2xl font-bold text-secondary mb-4">Merchant Info</h2>
            <div className="flex items-center space-x-4 mb-4">
              <img src="https://placehold.co/100x100" alt="Merchant" className="h-16 w-16 rounded-full" />
              <div>
                <h3 className="text-xl font-semibold text-text-main">{product.productMerchant}</h3>
                <Link to="#" className="flex items-center space-x-2 text-accent-gold hover:underline">
                  <FaStore />
                  <span>View Shop</span>
                </Link>
              </div>
          ...
          <div className="md:col-span-2 bg-support-gray-dark rounded-lg p-6">
            <h2 className="text-2xl font-bold text-secondary mb-4">Product Specifications</h2>
            <div className="space-y-4 text-text-secondary">
              <p>
                <span className="font-semibold text-text-main">Categories:</span>
                <span className="ml-2">{product.productCategory.join(", ")}</span>
              </p>
              <p>
              ...
              <p>
                <span className="font-semibold text-text-main">Description:</span>
